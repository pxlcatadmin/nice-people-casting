                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <button
                          ...
                          className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-nice-border text-xs text-gray-500 hover:border-gray-400 hover:text-gray-700 transition-colors"
                        >
                          {copiedSlug === job.id ? (
                            <>
